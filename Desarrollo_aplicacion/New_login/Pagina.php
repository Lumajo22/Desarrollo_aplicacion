...
<body>
        ...
        <div class="card-2">
            ...
            <div class="card-body">
                ...
                <p class="card-text">Saborea un manjar japonés en nuestra ciudad y disfruta de buenos combos, precios y
                    deleita tu paladar con nuevas experincias</p>
    ...
    <div class="container-2">
        <div class="card-4">
            ...
            <div class="card-body">
                ...
                <p class="card-text">Conoce de joyas unicas 100% a mano, hechos con mucho amor y ayuda a los jovenes a
                    crecer</p>
        ...
        <div class="card-5">
            ...
            <div class="card-body">
                ...
                <p class="card-text">Conoce nuestro hermoso mirador cerca a la ciudad de neiva y desconectate del mundo
        ...
        <div class="card-6">
            ...
            <div class="card-body">
                ...
                <p class="card-text">Apoya al talento juvenil y sus nueos emprendimientos , deleita tu paladar ccon una
                    explocion de sabores en Amorino </p>
    ...
    <div class="container-2">
        <div class="card-7">
            ...
            <div class="card-body">
                ...
                <p class="card-text">Disfruta de un exotico Hot-Dog hechos con mucho amor para que puedas saborear de
                    algo exotico</p>
        ...
        <div class="card-8">
            ...
            <div class="card-body">
                ...
                <p class="card-text">Abrete a tu sensualidad como mujer y disfruta de nuevas prendas</p>
    ...
    <main class="information">
        ...
        <h2>Derechos de admision</h2>
        <div class="information-content container">
            <div class="information-1">
                <h3>No hacemos reservaciones</h3>
                <p>
                    Somos una aplicacion web hecho para que puedas conocer nuevos lugares en la region del Huila, saber sobre sus redes sociales y  su ubicacion. Recuerda que no realizamos
                    reservas en estos lugares.
                </p>
             
            </div>
            <div class="information-1">
                <h3>Descubre lo mas nuevo</h3>
                <p>
                   Conoce nuestros emprendimientos 100% Huilenses de los ciudadanos de nuestra region y explora nuevas experiencias y 
    ...
    <footer class="footer container">
        ...
        <p> Esta es una pagina web hecha con mucho amor para todos nuestro usuarios</p>
        </div>
